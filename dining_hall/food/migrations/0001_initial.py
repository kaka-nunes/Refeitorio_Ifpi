    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limit_quantity', models.PositiveIntegerField(blank=True, null=True, verbose_name='quantidade restante')),
                ...
                ('registered_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='accounts.servant', verbose_name='usuário que cadastrou')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motive', models.CharField(blank=True, max_length=255, null=True, verbose_name='motivo da pendência')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='criado em')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='modificado em')),
                ...
                ('user_removed_pending', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='accounts.servant', verbose_name='usuário que retirou a pendência')),
            ],
            options={
